...
proc buildLibs(nimFlags = "") = 
  ...
  exec "gcc -shared -o tests/" & application & "." & cDllExtension & " -Wl,--out-implib,tests/lib" & application & ".a -Wl,--whole-archive tmp_c/*.o -Wl,--no-whole-archive " & minGwSymbols & webviewlLibs # -Wl,--export-all-symbols -Wl,--enable-auto-import
